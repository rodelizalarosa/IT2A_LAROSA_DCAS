...
public class Verify extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(inputPIN, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 290, 350, 40));
        ...
        jPanel1.add(email3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 390, 30));
        ...
        jPanel1.add(checkPIN, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 350, 130, 30));
    ...
    private void checkPINMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_checkPINMouseClicked
         try {
            ...
            JOptionPane.showMessageDialog(
                this,
                "<html><b>❌ An error occurred during verification.</b></html>",
                "Error",
                JOptionPane.ERROR_MESSAGE
            );
        }
