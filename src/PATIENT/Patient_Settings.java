...
public class Patient_Settings extends javax.swing.JFrame {
    ...
    public Patient_Settings() {
        ...
        Session.getInstance().setDesktopSettings(secondDesktop);
        
    }
    
    private void showProfile() {
        Patient_Profile prof = new Patient_Profile();
        secondDesktop.add(prof);
        prof.setVisible(true);
    }
    
     private void showSecurity() {
        Patient_Security sec = new Patient_Security();
        secondDesktop.add(sec);
        sec.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        secondDesktop = new javax.swing.JDesktopPane();
        ...
        secondDesktop.setBackground(new java.awt.Color(204, 204, 204));
        secondDesktop.setLayout(new java.awt.BorderLayout());
        jPanel1.add(secondDesktop, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 0, 880, 560));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Patient_Settings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Patient_Settings().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JDesktopPane secondDesktop;
