...
public class Patient_Change_Password extends javax.swing.JFrame {

    public Patient_Change_Password() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        change.add(delete1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 150, 30));

        jPanel1.add(change, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 450, 170, 30));
        ...
        jPanel1.add(email4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 280, 350, 30));
        ...
        jPanel1.add(newPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 310, 340, 40));
        ...
        jPanel1.add(email5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 360, 350, 30));
        ...
        jPanel1.add(confirmPass, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 390, 340, 40));

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/verify.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, 260, -1));
        ...
        account1.setText("Change Password");
        ...
        jPanel1.add(cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 450, 130, 30));
    ...
    private void changeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_changeMouseClicked
        try {
            ...
            if (newPassword.isEmpty() || confirmPassword.isEmpty()) {
                JOptionPane.showMessageDialog(
                    this,
                    "<html><b>Password fields cannot be empty.</b><br>Please enter your new password and confirmation.</html>",
                    "Validation Error",
            ...
            if (hashedNewPassword == null) {
                JOptionPane.showMessageDialog(
                    this,
                    "<html><b>Failed to hash the password.</b><br>Please try again later.</html>",
                    "Hashing Error",
                    JOptionPane.ERROR_MESSAGE
                );
                return;
            ...
            // Log the event (consider adding more details if needed)
            Session.getInstance().logEvent("PASSWORD CHANGE", "User successfully changed their password.");

            // Notify the user of success
            JOptionPane.showMessageDialog(
                this,
                "<html><b>Your password has been changed successfully!</b><br>You can now log in with your new password.</html>",
        ...
        // Handle database-specific exceptions
            ...
            JOptionPane.showMessageDialog(
                this,
                "<html><b>An unexpected error occurred while changing your password.</b><br>Please try again later.</html>",
                "Error",
                JOptionPane.ERROR_MESSAGE
            );
        }
    ...
    private void cancelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cancelMouseClicked
        Patient_Security_Verify sec = new Patient_Security_Verify();
        sec.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Patient_Change_Password.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Patient_Change_Password().setVisible(true);
            }
        });
    }
