...
public class Patient_Security_Verify extends javax.swing.JFrame {

    public Patient_Security_Verify() {
        initComponents();
    }
    ...
    private void cancelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cancelMouseClicked
        Patient_Security_Email sec = new Patient_Security_Email();
        sec.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Patient_Security_Verify.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
